...
public class MapManager : MonoBehaviour {
    ...
    {        
        ...
        //StartCoroutine(GenerateCompositeCollider());  // milim da tega ne bom uporabljal
    ...
    void GenerateMap()
    {
        ...
        /// random generiranje
        /// Vrjetno bom mogu premaktn to v svojo skripto
...
*/
    ...
    {
        // če bi hotel random pozicijo
        /*
        int xStartPosOfTank = Random.Range((int)((4 * tankIndex + 1) / 8f * mapWidth), (int)((4 * tankIndex + 3) / 8f * mapWidth));
        int yStartPosOfTank = heightArray[xStartPosOfTank];

        //print((4 * tankIndex + 1) / 8f + "    " + (4 * tankIndex + 3) / 8f);
        */
    ...
    void SendMapInfoToTanks()
    {
        ...
        foreach (GameObject tank in tanks)
        {
            ...
            tank.GetComponent<TankMoveAndAim>().mapHightArray = heightArray;
            // rečemo naj pogleda če se rabi tank kaj premakniti
            tank.GetComponent<TankMoveAndAim>().SetCoorectionBool(true);
        }
